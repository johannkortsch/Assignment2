...
class PhraseList1 extends Component {
  constructor (props) {
    super(props)
  ...
  *************************************************************/
  ...
  renderRow (rowData, sectionID) {
    ...
    // später ggf. componentWillReceiveProps für List Update
      ...
      >
        <Text style={styles.boldLabel}>{rowData.german}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(PhraseList1)
