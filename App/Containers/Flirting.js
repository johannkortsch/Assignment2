...
import { Button, View, SectionList, Text, TouchableOpacity, Alert, Clipboard, Share, Animated, StackNavigator} from 'react-native'
...
class Flirting extends React.PureComponent {
...
export default connect(mapStateToProps, mapDispatchToProps)(Flirting)
